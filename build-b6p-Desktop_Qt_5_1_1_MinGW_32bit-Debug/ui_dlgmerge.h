...
public:
    ...
    {
        DlgMerge->setWindowTitle(QApplication::translate("DlgMerge", "Simultaneous edition conflict", 0));
        ...
        ___qtablewidgetitem3->setText(QApplication::translate("DlgMerge", "Result", 0));
    } // retranslateUi
