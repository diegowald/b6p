...
public:
    ...
    void setupUi(QDialog *DlgPlanificacionDia)
    {
        ...
        QIcon icon1;
        icon1.addFile(QStringLiteral(":/img/remove"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon3;
        icon3.addFile(QStringLiteral(":/img/images/glyphicons_151_new_window.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon4;
        icon4.addFile(QStringLiteral(":/img/add"), QSize(), QIcon::Normal, QIcon::Off);
        btnAdd->setIcon(icon4);

        gridLayout->addWidget(btnAdd, 0, 0, 1, 1);

        toolButton = new QToolButton(DlgPlanificacionDia);
        toolButton->setObjectName(QStringLiteral("toolButton"));
        QIcon icon5;
        icon5.addFile(QStringLiteral(":/img/employees"), QSize(), QIcon::Normal, QIcon::Off);
